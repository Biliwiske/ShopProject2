...
#from app_product.app.services.product_service import ProductService
#from app_product.app.repositories.db_product_repo import ProductRepo
...
#             data['order_id'], data['type'], data['product'], data['customer_info'])
#         await msg.ack()
#     except:
#         traceback.print_exc()
#         await msg.ack()
